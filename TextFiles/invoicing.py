...
def record_invoice(invoice_file: TextIO,
    ...
    Args:
        invoice_file: An open text file, opened using r+.
        company: The name of the company being invoiced.
        amount: The amount of the invoice.
        last_line_ptr: The position of the start of the last 
    line in the file. This will be obtained by the previous 
    call to `record_invoice`.
    Return
        last_line_ptr (int): The position of the start of the line in the file. 
    ...
    if last_row:
        ...
        # If the file is empty, we start numbering from 1.
        year = get_year()
