...
class Album:
    ...
    def add_song(self, song, position=None):
        ...
        Args:
            ...
            position (int, optional): The song will be added to that position in the 
                track list - inserting it between other songs if necessary. 
...
def create_checkfile(artist_list):
    """Creae a check file from the object data for comparison with the original file

    Args:
        artist_list (_type_): _description_
    """
